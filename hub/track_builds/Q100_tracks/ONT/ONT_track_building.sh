...
cd /public/groups/migalab/HG002v1.1_censat_browser/hub/track_builds/Q100_tracks/ONT
awk 'BEGIN{FS=OFS="\t"} { $5=1; print }' beds/Q100_ONT_5mC_HG002v1.1.winnowmap_q10_10kb.centrodip.bed > beds/Q100_ONT_5mC_HG002v1.1.winnowmap_q10_10kb.centrodip.bed.tmp
mv beds/Q100_ONT_5mC_HG002v1.1.winnowmap_q10_10kb.centrodip.bed.tmp beds/Q100_ONT_5mC_HG002v1.1.winnowmap_q10_10kb.centrodip.bed
bedToBigBed \
    -type=bed9 \
    -as=/public/groups/migalab/HG002v1.1_censat_browser/hub/track_builds/Q100_tracks/HiFi/autosql/HiFi_centrodip_CDR.as \
	beds/Q100_ONT_5mC_HG002v1.1.winnowmap_q10_10kb.centrodip.bed \
	/public/groups/migalab/HG002v1.1_censat_browser/hub/hg002v1.1.fasta.2bit.sizes \
	Q100_ONT_5mC_HG002v1.1.winnowmap_q10_10kb.centrodip.bb